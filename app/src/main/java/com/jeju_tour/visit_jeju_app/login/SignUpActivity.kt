package com.jeju_tour.visit_jeju_app.login
...
import com.jeju_tour.visit_jeju_app.databinding.ActivitySignUpBinding
import com.jeju_tour.visit_jeju_app.login.model.User
import com.jeju_tour.visit_jeju_app.retrofit.addUserToMysql
...
class SignUpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnUserAgreement = findViewById<TextView>(com.jeju_tour.visit_jeju_app.R.id.btnUserAgreement)
        btnUserAgreement.paintFlags = btnUserAgreement.paintFlags or Paint.UNDERLINE_TEXT_FLAG

        // 두 번째 TextView에 밑줄 추가
        val btnPrivacyPolicy = findViewById<TextView>(com.jeju_tour.visit_jeju_app.R.id.btnPrivacyPolicy)
    ...
    fun openFragment(view: View) {
        val fragment = when (view.id) {
            com.jeju_tour.visit_jeju_app.R.id.btnPrivacyPolicy -> PrivacyPolicyFragment()
            com.jeju_tour.visit_jeju_app.R.id.btnUserAgreement -> UserAgreementFragment()
            else -> return
        }
