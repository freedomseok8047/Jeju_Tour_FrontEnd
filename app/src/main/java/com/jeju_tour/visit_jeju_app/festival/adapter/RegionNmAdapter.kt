package com.jeju_tour.visit_jeju_app.festival.adapter
...
import com.jeju_tour.visit_jeju_app.databinding.ItemRegionnmBinding
import com.jeju_tour.visit_jeju_app.festival.FesRegionNmActivity
import com.jeju_tour.visit_jeju_app.festival.model.FesList
import com.jeju_tour.visit_jeju_app.festival.regionNmDetailFesActivity


class RegionNmViewHolder(val binding: ItemRegionnmBinding) : RecyclerView.ViewHolder(binding.root)
class RegionNmAdapter(val context: FesRegionNmActivity, val datas: List<FesList>?) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.binding.root.setOnClickListener {
            val intent = Intent(holder.binding.root?.context, regionNmDetailFesActivity::class.java)
