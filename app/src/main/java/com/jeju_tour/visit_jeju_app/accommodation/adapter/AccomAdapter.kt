package com.jeju_tour.visit_jeju_app.accommodation.adapter
...
import com.jeju_tour.visit_jeju_app.databinding.ItemAccomBinding
import com.jeju_tour.visit_jeju_app.accommodation.AccomDetailActivity
import com.jeju_tour.visit_jeju_app.accommodation.model.AccomList

class AccomViewHolder(val binding: ItemAccomBinding): RecyclerView.ViewHolder(binding.root)
class AccomAdapter(val context: AccomActivity, val datas:MutableList<AccomList>?): RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder
            = AccomViewHolder(ItemAccomBinding.inflate(LayoutInflater.from(parent.context), parent, false))

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val binding=(holder as AccomViewHolder).binding
