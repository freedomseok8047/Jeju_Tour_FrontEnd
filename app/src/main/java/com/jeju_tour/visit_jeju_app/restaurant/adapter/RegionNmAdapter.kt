package com.jeju_tour.visit_jeju_app.restaurant.adapter
...
import com.jeju_tour.visit_jeju_app.restaurant.ResRegionNmActivity
import com.jeju_tour.visit_jeju_app.restaurant.model.ResList
import com.jeju_tour.visit_jeju_app.restaurant.regionNmDetailResActivity


class RegionNmViewHolder(val binding: ItemRegionnmBinding) : RecyclerView.ViewHolder(binding.root)
class RegionNmAdapter(val context: ResRegionNmActivity, val datas: List<ResList>?) :
