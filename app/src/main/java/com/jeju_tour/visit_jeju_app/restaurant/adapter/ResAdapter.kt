...
import com.jeju_tour.visit_jeju_app.databinding.ItemResBinding
import com.jeju_tour.visit_jeju_app.restaurant.ResActivity
import com.jeju_tour.visit_jeju_app.restaurant.ResDetailActivity
...
class ResAdapter(val context: ResActivity, val datas:MutableList<ResList>?): RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder
            = ResViewHolder(ItemResBinding.inflate(LayoutInflater.from(parent.context), parent, false))
