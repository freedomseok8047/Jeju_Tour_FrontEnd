...
//        mLocationRequest = LocationRequest.Builder(Priority.PRIORITY_HIGH_ACCURACY, timeInterval).apply {
...
//        )
    ...
    private fun getTourListWithinRadius(coords: String) {
        ...
        tourListCall.enqueue(object : Callback<List<TourModel>> {
...
//                var itemsLongitude : String,
                ...
                val touristSpotsWithinRadius = tourList?.mapNotNull { spot ->
                    val distance = haversineDistance(
                        ...
                        spot.itemsLatitude.toDouble(), spot.itemsLongitude.toDouble()
                    )
                    if (distance <= radius) {
