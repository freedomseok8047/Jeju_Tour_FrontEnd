...
import com.example.visit_jeju_app.databinding.ActivityAuthBackBinding
...
class Auth_back_Activity : AppCompatActivity() {
    private lateinit var auth: FirebaseAuth
    lateinit var binding: ActivityAuthBackBinding

    //    private lateinit var database: DatabaseReference
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityAuthBackBinding.inflate(layoutInflater)
                ...
                .addOnCompleteListener(this){ task ->
                    ...
                    if(task.isSuccessful){
                        if(MyApplication.checkAuth()){
                            ...
                            val intent = Intent(this@Auth_back_Activity, MainActivity::class.java)
